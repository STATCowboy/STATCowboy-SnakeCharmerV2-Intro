...
winePD = pd.read_csv(os.path.join(APP_DATA, "winequality-red.csv"), sep=';')
print(type(winePD))
...
winePDwhite = pd.read_csv(os.path.join(APP_DATA, "winequality-white.csv"), sep=';')
...
wineNP = np.loadtxt(os.path.join(APP_DATA, "winequality-red.csv"), delimiter=';', skiprows=1)
print(type(wineNP))
